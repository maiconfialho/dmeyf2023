...
PARAM$experimento <- "HT5230_fe_lag"

PARAM$input$dataset <- "./datasets/competencia_02_fe_lag_limpio.csv.gz"
...
EstimarGanancia_lightgbm <- function(x) {
  ...
  if (ganancia_normalizada > GLOBAL_gananciamax) {
    ...
    archivo_importancia <- paste0("impo_fe", GLOBAL_iteracion, ".txt")
