...
dataset[, tiempo_sin_aumento := cumsum(!aumento_saldo_corriente), by = numero_de_cliente]
...
dataset[, tiempo_sin_aumento := cumsum(!aumento_saldo_ahorro), by = numero_de_cliente]
...
dataset[, tiempo_sin_disminuir := cumsum(!disminuye_saldo_corriente), by = numero_de_cliente]
...
dataset[, tiempo_sin_disminuir := cumsum(!disminuye_saldo_ahorro), by = numero_de_cliente]
